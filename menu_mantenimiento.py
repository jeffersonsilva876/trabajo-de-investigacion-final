...
from helpers import gotoxy,borrarPantalla,valida
import time
class Carrera:
...
def profesores():
   ...
   ced=validar.solo_numeros("Error: ingrese solo digitos",25,5)
   ...
   if grabar == "s":
        ...
        gotoxy(15,11);print("Registro Grabado Satisfactoriamente")
        gotoxy(15,12);input("Presione una tecla para continuar...")
   else:
       gotoxy(15,11);print("Su Registro No fue Grabado") 
       gotoxy(15,12);input("Presione una tecla para continuar...")
...
def estudiantes():
   ...
   gotoxy(15,7);print("Telefono: ")
   nom = validar.solo_letras("Error: solo ingrese letras",25,4)
   ced=validar.solo_numeros("Error: solo ingrese solo digitos",25,5)
   gotoxy(28,6);direccion = input()
   tel=validar.solo_numeros("Error: Solo numeros",26,7)
