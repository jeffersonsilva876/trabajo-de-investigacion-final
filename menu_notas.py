...
from menu_mantenimiento import Periodo,Estudiante,Materia,Profesor
import time
class Notas: 
...
def ingresonotas():
   ...
   if grabar == "s":
        ...
        gotoxy(15,12);print("Registro Grabado Satisfactoriamente")
        gotoxy(15,13);input("Presione una tecla para continuar....")
   else:
       gotoxy(15,12);print("El registro no fue grabado")
       gotoxy(15,13);input("Presione una tecla para continuar....")