    ...
    if opc=="1":
        ...
        while opc1!="6":
            ...
            if opc1=="1":
                ...
                gotoxy(20,19);print("Presione para volver a MENU PRINCIPAL")
                gotoxy(20,20);input()
            else:
                gotoxy(20,19);print("la opcion {} no existe".format(opc1))
                time.sleep(2)
    elif opc=="2":
        opc2=""
        while opc2!="2":
            ...
            if opc2=="1":
                ...
                gotoxy(20,15);print("Presione para volver a MENU PRINCIPAL")
                gotoxy(20,16);input()
            else:
                gotoxy(20,15);print("la opcion {} no existe".format(opc2))
                time.sleep(2)
    elif opc=="3":
        opc3=""
        while opc3!="2":
            ...
            if opc3=="1":
                ...
                gotoxy(20,15);print("la opcion {} no existe".format(opc3))
                time.sleep(2)
    elif opc>"4":
        gotoxy(20,17);print("La opcion {} no es valida".format(opc))
        time.sleep(1)

gotoxy(20,17);print("Gracias por visitarnos")